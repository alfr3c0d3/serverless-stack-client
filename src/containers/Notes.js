  ...
  useEffect(() => {
    ...
    const onLoad = async () => {
      try {
        ...
        if (attachment) note.attachmentURL = await Storage.vault.get(attachment);
    ...
    <div className="Notes">
      {note && (
        <Form onSubmit={handleSubmit}>
          ...
          <LoaderButton block size="lg" variant="danger" isLoading={isDeleting} onClick={handleDelete}>
            Delete
          </LoaderButton>
        </Form>
      )}
